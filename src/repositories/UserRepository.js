 ...
 * 
 * NOTE: Dalam browser environment, User class sudah tersedia
 * di global scope melalui script tag di HTML
 */

// Import User class untuk Node.js environment (testing)
// Di browser, User sudah tersedia di global scope
