 ...
 * 
 * NOTE: Dalam browser environment, EnhancedTask class sudah tersedia
 * di global scope melalui script tag di HTML
 */

// Import EnhancedTask class untuk Node.js environment (testing)
// Di browser, EnhancedTask sudah tersedia di global scope
